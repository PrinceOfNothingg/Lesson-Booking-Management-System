...
public class Booking {
    ...
    protected Booking() {}
    public Booking(long id, boolean active,  String status, long clientId, long offeringId, String offeringStatus, boolean taken, String type, boolean mode, int seats) {
        this.id = id;
        this.active = active;
